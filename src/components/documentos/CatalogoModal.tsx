  ...
  return (
    ...
    >
              ...
              <div className="flex-1">
                ...
                {(errorMessage.toLowerCase().includes('storage') ||
                  ...
                  <button
                    ...
                    className="mt-2.5 inline-flex items-center gap-1.5 px-3 py-1.5 bg-rose-100 hover:bg-rose-200 text-rose-900 font-bold rounded-lg transition-colors cursor-pointer text-xs"
                  >
                    <Database className="w-3.5 h-3.5 text-rose-700" />
                    <span>Ver Script SQL do Supabase Storage</span>
                  </button>
                )}
              </div>
            </div>
      ...
      <SupabaseStorageConfigModal
        isOpen={isStorageConfigOpen}
        onClose={() => setIsStorageConfigOpen(false)}
      />
    </div>
  );
};
