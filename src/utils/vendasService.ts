          ...
          const updatedMetas = metasSales.map((m: any) => {
            ...
            if ((cleanPuro && mPuro && cleanPuro === mPuro) || (fullVenda.metaId && m.id === fullVenda.metaId)) {
              ...
              return {
                ...
                formaPagamento: fullVenda.formaPagamento || m.formaPagamento,
                formasPagamento: fullVenda.formasPagamento || m.formasPagamento,
                parcelas: fullVenda.parcelas || m.parcelas,
                desconto: fullVenda.desconto !== undefined ? fullVenda.desconto : m.desconto,
                frete: fullVenda.frete !== undefined ? fullVenda.frete : m.frete,
              };
            }
            return m;
          });
